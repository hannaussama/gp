...
//                                     bool isCellDisabled = layerIndex > 0 &&
//                                         layers[layerIndex - 1][index ~/ gridSize][index % gridSize] == null;
//
...
//                                                 : layers[layerIndex][index ~/ gridSize][index % gridSize]?.color ?? Colors.white,
//                                             child: Center(
//                                               child: Text(
...
//                                           );
//                                         },
//                                         onAccept: isCellDisabled
//                                             ? null // Prevent drop if the cell is disabled
//                                             : (shape) {
...
//     return Container(
//       color: shape.color,
//       width: shape.type == ShapeType.square ? 50 : 100,
//       height: 50,
//       child: Center(
//         child: Text(
//           shape.type == ShapeType.square ? "Square" : "Rectangle",
